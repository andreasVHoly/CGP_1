...
void TestMesh::testMeshing()
{
    ...
    Mesh test1a;
    CPPUNIT_ASSERT(test1a.readSTLTEST(header+"bunny.stl"));
    ...
    Mesh test1b;
    CPPUNIT_ASSERT(test1b.readSTLTEST(header+"dragon.stl"));
    CPPUNIT_ASSERT(test1b.prepareEdges() == 896925);


    //TEST 1C
    //BASIC PRE-EXISTING TEST FOR BUNNY
    CPPUNIT_ASSERT(mesh->readSTLTEST(header+"bunny.stl"));
    ...
    if (true){
        Mesh pyramid;
        CPPUNIT_ASSERT(pyramid.readSTLTEST(header+"pyramid.stl"));
    ...
    if (true){
        Mesh cube;
        CPPUNIT_ASSERT(cube.readSTLTEST(header+"Cube2.stl"));
        cube.prepareEdges();
    ...
    if (true){
        Mesh test4;
        CPPUNIT_ASSERT(test4.readSTLTEST(header+"Cube2.stl"));
        test4.prepareEdges();
    ...
    if (true){
        Mesh test5;
        CPPUNIT_ASSERT(test5.readSTLTEST(header+"TestGenus1.stl"));
        test5.prepareEdges();
    ...
    if (true){
        Mesh test6;
        CPPUNIT_ASSERT(test6.readSTLTEST(header+"Cube2.stl"));
        test6.prepareEdges();
    ...
    if (true){
        Mesh test7;
        CPPUNIT_ASSERT(test7.readSTLTEST(header+"TestDanglingVertices.stl"));
        test7.prepareEdges();
    ...
    if (true){
        Mesh test8;
        CPPUNIT_ASSERT(test8.readSTLTEST(header+"basic_sphere.stl"));//known to have vertices in bounds
        test8.prepareEdges();
    ...
    if (true){
        Mesh test9;
        CPPUNIT_ASSERT(test9.readSTLTEST(header+"TestGenus1.stl"));
        test9.prepareEdges();
        //CPPUNIT_ASSERT(!test8.vertexBoundsTest());
    ...
    if (true){
        Mesh test10;
        CPPUNIT_ASSERT(test10.readSTLTEST(header+"basic_sphere.stl"));
    ...
    if (true){
        Mesh test11;
        CPPUNIT_ASSERT(test11.readSTLTEST(header+"TestClosed.stl"));
    ...
    if (true){
        Mesh test12;
        CPPUNIT_ASSERT(test12.readSTLTEST(header+"basic_sphere.stl"));
    ...
    if (true){
        Mesh test13;
        CPPUNIT_ASSERT(test13.readSTLTEST(header+"TestOrientable.stl"));
    ...
    if (true){
        Mesh test14;
        CPPUNIT_ASSERT(test14.readSTLTEST(header+"basic_sphere.stl"));
    ...
    if (true){
        Mesh test15;
        CPPUNIT_ASSERT(test15.readSTLTEST(header+"TwoManifoldTestFail.stl"));
